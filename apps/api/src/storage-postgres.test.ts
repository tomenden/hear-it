...
function rowFromInsert(values: unknown[]): SqlRow {
  return {
    ...
    live_edge_updated_at: values[6],
    lease_owner: values[7],
    lease_expires_at: values[8],
    run_id: values[9],
    attempt: values[10],
    article: values[11],
    speech_options: values[12],
    provider: values[13],
    audio_url: values[14],
    playlist_url: values[15],
    audio_segments: values[16],
    duration_seconds: values[17],
    error: values[18],
